...
<html lang="en">
  ...
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="nama_kelas">
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">kompetensi keahlian</label>
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="kompetensi_keahlian">
</div>
