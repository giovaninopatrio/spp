...
<br>
            <div class="container">
                <a href="tambah_petugas.php" class="btn btn-secondary">tambah data petugas</a>
                    ...
                    <tr>
                        ...
                        ?>
                         <td><?php echo $no;?></td>
                        <td><?php echo $kotak["id_petugas"];?></td>
                        <td><?php echo $kotak["username"];?></td>
                        <td><?php echo $kotak["password"];?></td>
                        <td><?php echo $kotak["nama_petugas"];?></td>
                        <td><?php echo $kotak["level"];?></td>
                        <td> <a href="edit_petugas.php"  class="btn btn-primary">edit</a> 
                            <a href="hapus_petugas.php?id_petugas=<?php echo $kotak["id_petugas"];?>" class="btn btn-danger">hapus</a>
                        </td>
                    </tr>
                    <?php
                    $no++;
