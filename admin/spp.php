...
<br>
            <div class="container">
              <a href="tambah_data_spp.php" class="btn btn-secondary">TAMBAH DATA SPP</a>
                    ...
                    <tr>
                        ...
                        ?>
                         <td><?php echo $no;?></td>
                        <td><?php echo $kotak["id_spp"];?></td>
                        <td><?php echo $kotak["tahun"];?></td>
                        <td><?php echo $kotak["nominal"];?></td>
                        <td> <a href="edit_spp.php?id_spp=<?php echo $kotak["id_spp"];?>"  class="btn btn-primary">edit</a> 
                            <a href="hapus_spp.php?id_spp=<?php echo $kotak["id_spp"];?>" class="btn btn-danger">hapus</a>
                        </td>
                    </tr>
                    <?php
                    $no++;
